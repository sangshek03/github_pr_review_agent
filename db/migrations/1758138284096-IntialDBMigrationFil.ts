...
export class  IntialDBMigrationFile1758138284096 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "githubagent"."pr_files_change_type_enum" AS ENUM('added', 'modified', 'deleted', 'renamed', 'removed', 'changed', 'copied')`);
        ...
        await queryRunner.query(`CREATE TYPE "githubagent"."chat_messages_sender_type_enum" AS ENUM('user', 'bot')`);
        await queryRunner.query(`CREATE TYPE "githubagent"."chat_messages_message_type_enum" AS ENUM('text', 'code', 'json', 'markdown')`);
        await queryRunner.query(`CREATE TABLE "githubagent"."chat_messages" ("message_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "sender_type" "githubagent"."chat_messages_sender_type_enum" NOT NULL, "message_type" "githubagent"."chat_messages_message_type_enum" NOT NULL, "message_content" text NOT NULL, "context_used" jsonb, "query_classification" character varying(50), "response_metadata" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "session_id" uuid, CONSTRAINT "PK_300f1fa55a5fffb36c7763b2de8" PRIMARY KEY ("message_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_52d89390506ed998a56a73c04c" ON "githubagent"."chat_messages" ("created_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_ae763c9552786328a3d8002c93" ON "githubagent"."chat_messages" ("sender_type") `);
        await queryRunner.query(`CREATE INDEX "IDX_0672782561e44d43febcfba298" ON "githubagent"."chat_messages" ("session_id") `);
        await queryRunner.query(`CREATE TYPE "githubagent"."chat_sessions_session_type_enum" AS ENUM('PR_SPECIFIC', 'REPOSITORY_WIDE')`);
        await queryRunner.query(`CREATE TABLE "githubagent"."chat_sessions" ("session_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "session_name" character varying(255) NOT NULL, "session_type" "githubagent"."chat_sessions_session_type_enum" NOT NULL, "last_activity" TIMESTAMP NOT NULL DEFAULT now(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "user_id" uuid, "pr_metadata_id" uuid, "repository_id" uuid, CONSTRAINT "PK_6ccb7b732f5af0bde672165cadf" PRIMARY KEY ("session_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_d815db3343ef9ab637c7f89b51" ON "githubagent"."chat_sessions" ("last_activity") `);
        await queryRunner.query(`CREATE INDEX "IDX_afdbb1c6c0c87a17650d9a0fde" ON "githubagent"."chat_sessions" ("session_type") `);
        await queryRunner.query(`CREATE INDEX "IDX_2cc747b1ca87b4b6d5f5afa00e" ON "githubagent"."chat_sessions" ("repository_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_beb832eb495ea164822cb6b89e" ON "githubagent"."chat_sessions" ("pr_metadata_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_1fa209cf48ae975a109366542a" ON "githubagent"."chat_sessions" ("user_id") `);
        await queryRunner.query(`CREATE TABLE "githubagent"."pr_summary" ("pr_summary_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "summary" text NOT NULL, "issues_found" jsonb NOT NULL, "suggestions" jsonb NOT NULL, "test_recommendations" jsonb NOT NULL, "overall_score" integer NOT NULL DEFAULT '0', "security_concerns" jsonb NOT NULL, "performance_issues" jsonb NOT NULL, "well_handled_cases" jsonb NOT NULL, "future_enhancements" jsonb NOT NULL, "code_quality_rating" jsonb NOT NULL, "analysis_model" character varying(50), "analysis_timestamp" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "user_id" uuid, "pr_review_id" uuid, CONSTRAINT "PK_7e8e858999da4dbf876d29a77a8" PRIMARY KEY ("pr_summary_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "githubagent"."chat_messages" ADD CONSTRAINT "FK_0672782561e44d43febcfba2984" FOREIGN KEY ("session_id") REFERENCES "githubagent"."chat_sessions"("session_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "githubagent"."chat_sessions" ADD CONSTRAINT "FK_1fa209cf48ae975a109366542a5" FOREIGN KEY ("user_id") REFERENCES "githubagent"."users"("user_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "githubagent"."chat_sessions" ADD CONSTRAINT "FK_beb832eb495ea164822cb6b89ea" FOREIGN KEY ("pr_metadata_id") REFERENCES "githubagent"."pr_metadata"("pr_metadata_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "githubagent"."chat_sessions" ADD CONSTRAINT "FK_2cc747b1ca87b4b6d5f5afa00ea" FOREIGN KEY ("repository_id") REFERENCES "githubagent"."repositories"("repository_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "githubagent"."pr_summary" ADD CONSTRAINT "FK_ba338a5a76356ca1530c67ab5bc" FOREIGN KEY ("user_id") REFERENCES "githubagent"."users"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "githubagent"."pr_summary" ADD CONSTRAINT "FK_d9759e6df441c11c179c80922ac" FOREIGN KEY ("pr_review_id") REFERENCES "githubagent"."pr_reviews"("pr_review_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "githubagent"."pr_summary" DROP CONSTRAINT "FK_d9759e6df441c11c179c80922ac"`);
        await queryRunner.query(`ALTER TABLE "githubagent"."pr_summary" DROP CONSTRAINT "FK_ba338a5a76356ca1530c67ab5bc"`);
        await queryRunner.query(`ALTER TABLE "githubagent"."chat_sessions" DROP CONSTRAINT "FK_2cc747b1ca87b4b6d5f5afa00ea"`);
        await queryRunner.query(`ALTER TABLE "githubagent"."chat_sessions" DROP CONSTRAINT "FK_beb832eb495ea164822cb6b89ea"`);
        await queryRunner.query(`ALTER TABLE "githubagent"."chat_sessions" DROP CONSTRAINT "FK_1fa209cf48ae975a109366542a5"`);
        await queryRunner.query(`ALTER TABLE "githubagent"."chat_messages" DROP CONSTRAINT "FK_0672782561e44d43febcfba2984"`);
        ...
        await queryRunner.query(`DROP INDEX "githubagent"."IDX_1fa209cf48ae975a109366542a"`);
        await queryRunner.query(`DROP INDEX "githubagent"."IDX_beb832eb495ea164822cb6b89e"`);
        await queryRunner.query(`DROP INDEX "githubagent"."IDX_2cc747b1ca87b4b6d5f5afa00e"`);
        await queryRunner.query(`DROP INDEX "githubagent"."IDX_afdbb1c6c0c87a17650d9a0fde"`);
        await queryRunner.query(`DROP INDEX "githubagent"."IDX_d815db3343ef9ab637c7f89b51"`);
        await queryRunner.query(`DROP TABLE "githubagent"."chat_sessions"`);
        await queryRunner.query(`DROP TYPE "githubagent"."chat_sessions_session_type_enum"`);
        await queryRunner.query(`DROP INDEX "githubagent"."IDX_0672782561e44d43febcfba298"`);
        await queryRunner.query(`DROP INDEX "githubagent"."IDX_ae763c9552786328a3d8002c93"`);
        await queryRunner.query(`DROP INDEX "githubagent"."IDX_52d89390506ed998a56a73c04c"`);
        await queryRunner.query(`DROP TABLE "githubagent"."chat_messages"`);
        await queryRunner.query(`DROP TYPE "githubagent"."chat_messages_message_type_enum"`);
        await queryRunner.query(`DROP TYPE "githubagent"."chat_messages_sender_type_enum"`);
