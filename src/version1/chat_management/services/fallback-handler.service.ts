...
export class FallbackHandlerService {
  ...
  handleMissingContext(queryType: QueryType): ChatLLMResponse {
    ...
    const fallbackMap = {
      [QueryType.SUMMARY]: {
        answer:
          "I apologize, but I don't have access to the PR summary information. To get a summary of this PR, please ensure the PR has been fetched and analyzed first.",
        followup_questions: [
      ...
      [QueryType.CODE_ANALYSIS]: {
        answer:
          "I don't have access to the code changes for this PR. The files and their modifications haven't been loaded yet. Please fetch the PR details first to analyze the code changes.",
        followup_questions: [
      ...
      [QueryType.REVIEWS]: {
        answer:
          "I don't have access to the review information for this PR. The reviews and comments haven't been loaded. Please ensure the PR has been fetched with all its review data.",
        followup_questions: [
      ...
      [QueryType.SECURITY]: {
        answer:
          "I don't have access to the security analysis for this PR. A security review hasn't been performed yet. Please run the PR analysis first to get security insights.",
        followup_questions: [
      ...
      [QueryType.PERFORMANCE]: {
        answer:
          "I don't have access to performance analysis data for this PR. Performance insights aren't available without running the PR analysis first.",
        followup_questions: [
      ...
      [QueryType.FILES]: {
        answer:
          "I don't have access to the file change information for this PR. The list of modified files hasn't been loaded. Please fetch the PR data first.",
        followup_questions: [
      ...
      [QueryType.TESTS]: {
        answer:
          "I don't have access to test recommendations for this PR. Test analysis requires the PR to be analyzed first.",
        followup_questions: [
      ...
      [QueryType.TIMELINE]: {
        answer:
          "I don't have access to the timeline information for this PR. The metadata hasn't been loaded yet.",
        followup_questions: [
      ...
      [QueryType.GENERAL]: {
        answer:
          "I don't have enough information about this PR to answer your question. The PR data hasn't been loaded yet.",
        followup_questions: [
  ...
  handleLLMFailure(query: string): ChatLLMResponse {
    ...
    return {
      answer:
        "I'm sorry, but I'm experiencing technical difficulties processing your question right now. This could be due to high server load or a temporary service issue. Please try again in a moment.",
      message_type: MessageType.TEXT,
      context_used: [],
      followup_questions: [
  ...
  handleInvalidResponse(
    ...
    if (
      ...
      typeof originalResponse.answer === 'string'
    ) {
  ...
  handleTimeoutError(query: string): ChatLLMResponse {
    ...
    return {
      answer:
        "I'm sorry, but your request is taking longer than expected to process. This might be due to the complexity of your question or current system load. Please try asking a more specific question or try again later.",
      message_type: MessageType.TEXT,
      context_used: [],
      followup_questions: [
  ...
  handleContextRetrievalFailure(queryType: QueryType): ChatLLMResponse {
    ...
    return {
      answer:
        "I'm having trouble accessing the relevant information to answer your question. This could be due to a database connection issue or missing data. Please try again, or ask a different question about this PR.",
      message_type: MessageType.TEXT,
      context_used: [],
      followup_questions: [
  ...
  handleRateLimitError(): ChatLLMResponse {
    ...
    return {
      answer:
        "I'm currently experiencing high demand and need to limit responses to ensure service availability for all users. Please wait a moment before asking your next question.",
      message_type: MessageType.TEXT,
      context_used: [],
      followup_questions: [
  ...
  handleUnknownError(query: string, error?: any): ChatLLMResponse {
    ...
    return {
      answer:
        'I encountered an unexpected error while processing your question. Our team has been notified and will investigate the issue. Please try asking your question differently or contact support if the problem persists.',
      message_type: MessageType.TEXT,
      context_used: [],
      followup_questions: [
